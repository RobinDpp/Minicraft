function menuFnc(){
    ...
    document.querySelectorAll('.scene').forEach(scene => {
        scene.classList.remove('active'); // Désactiver toutes les étapes
    });
    document.getElementById('menu').classList.add('active'); // Activer l'étape choisie
    ...
    document.getElementById('fullscreen-button').addEventListener('click', function() {
        ...
        document.getElementById('game').classList.add('active'); // Activer l'étape choisie
